...
OWNER_USERNAME = environ.get('OWNER_USERNAME', 'bujjifatherbot') # owner username without @
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("URL", "https://web-ojktett8xy31.up-de-fra1-k8s-1.apps.run-on-seenode.com/")
